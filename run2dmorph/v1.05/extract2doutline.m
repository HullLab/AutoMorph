function [obj_final,obj_edge,obj_smooth,sampleID,objectID] = extract2doutline(focused_image,image_name,sampleID,save_intermediates,intensity_range_in,intensity_range_out,gamma,threshold_adjustment,smoothing_sigma,limit)
%Output:
%
%   FILES:
...
noise_limit = ceil(limit * image_size);
