function batch2dmorph(directory,image_extension,sampleID,output_filename,microns_per_pixel_X,microns_per_pixel_Y,get_coordinates,save_intermediates,intensity_range_in,intensity_range_out,gamma,threshold_adjustment,smoothing_sigma,write_csv,downsample,num_points)
%Output:
%   
%   FILES:
...
for file = files'
    ...
    % Extract 2D outline
    [obj_final,obj_edge,obj_smooth,sampleID,objectID] = extract2doutline(new_image,file.name,sampleID,save_intermediates,intensity_range_in,intensity_range_out,gamma,threshold_adjustment,smoothing_sigma); 
