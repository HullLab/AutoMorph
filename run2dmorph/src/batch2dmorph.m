...
%
%   A text file containing all parameter settings named 'sampleID_objectID_parameters.csv'
%   is also outputted.
%
%   In addition, a file named 'output_filename_skipped.txt' is generated,
...
%   with a text file named 'sampleID_objectID_aspectratios.csv'. Note that
%   if draw_AR == true, then get_coordinates must also be true.
%
%   Finally, a log file named 'output_filename_log.txt' is also outputted.
%
%   All files are written to a folder named 'morph2d' nested within the
%   original folder containing the image files.
%
...
%   (Default: sampleID)
%
%	microns_per_pixel_X: a float specifying the number of microns per pixel along
%	the X-axis. (Default: 1)
%
%	microns_per_pixel_Y: a float specifying the number of microns per pixel along
