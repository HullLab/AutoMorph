function batch2dmorph(directory,image_extension,sampleID,output_filename,microns_per_pixel_X,microns_per_pixel_Y,get_coordinates,save_intermediates,intensity_range_in,intensity_range_out,gamma,threshold_adjustment,smoothing_sigma,noise_limit,write_csv,downsample,num_points)
%Output:
%   
%   FILES:
