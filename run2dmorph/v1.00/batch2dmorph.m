function final_table = batch2dmorph(directory,image_extension,sampleID,output_filename,microns_per_pixel,get_coordinates,save_intermediates,intensity_range_in,intensity_range_out,gamma,threshold_adjustment,smoothing_sigma,write_csv,downsample,num_points)
%Output:
%   
%   FILES:
...
%   named 'sampleID_objectID_parameters.csv' is also outputted.
%
